...
import de.juwimm.cms.authorization.model.*;
...
public class UserServiceSpringImpl extends UserServiceSpringBase {
	 ...
	 * <b>SECURITY INFORMATION:</b> Available only to: <i>createUser, siteRoot</i>
	 * 
	 * @todo Currently a User will be created inside the Database. Here we need an abstraction layer for JAAS style of user creation.
	 * @param userName
	 *            The username
	 * @param passwd
	 *            The Password
	 ...
	 * 
	 * @see de.juwimm.cms.remote.UserServiceSpring#createUser(java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.Integer)
	 */
	...
	protected void handleCreateUser(String userName, String passwd, String firstName, String lastName, String email, Integer initialUnitId) throws Exception {
		...
		// Bug 4078 if (email == null || email.equalsIgnoreCase("")) assertFields.add("user.email");
	 ...
	 * @param receiverRole
	 *            If there is no ReceiverUserId given, this Task has been submitted to a Group of people. In this case this is a Group of people with this specified Rights inside the specified Unit.
	 * @param unitId
	 *            The Unit this Task belongs to. In general the active unit the user is actually in.
	 * @param comment
	 ...
	 * 
	 * @see de.juwimm.cms.remote.UserServiceSpring#createTask(java.lang.String, java.lang.String, java.lang.Integer, java.lang.String, byte)
	 */
	@Override
	 ...
	 * 
	 * @see de.juwimm.cms.remote.UserServiceSpring#addViewComponentsToTask(java.lang.Integer, java.lang.Integer[])
	 */
	@Override
	protected void handleAddViewComponentsToTask(Integer taskId, Integer[] vcIds) throws Exception {
		...
		try {
			...
			if (task != null) {
				...
				Collection<ViewComponentHbm> coll = (Collection<ViewComponentHbm>) task.getViewComponents();
	 ...
	 * 
	 * @see de.juwimm.cms.remote.UserServiceSpring#removeViewComponentsFromTask(java.lang.Integer, java.lang.Integer[])
	 */
	@Override
	...
	/**
	 * Returns all users regardings the active site the logged user is in or if the logged in user is<br/> only unitAdmin, all Users for all Units he is in.<br/> The unitAdmin will not see
	 * SiteAdmins in his list, even they can see all Units. <b>SECURITY INFORMATION:</b> Available only to: <i>siteRoot, unitAdmin</i>
	 * 
	 * @return Returns all UserValue Objects in an Array. Is empty if nobody was found.
	 * 
	 ...
	 * 
	 * @return Returns all GroupValue Objects in an Array. Is empty if nobody was found.
	 * 
	 ...
	 * 
	 * @return Returns all RoleValue Objects in an Array. Is empty if nobody was found.
	 * 
	 ...
	 * If the Group will be <b>null</b>, it will return all users. <b>SECURITY INFORMATION:</b> Available only to: <i>siteRoot</i>
	 * 
	 * @param groupId
	 *            The Group
	 * @return Returns all UserValue Objects in an Array. Is empty if nobody was found.
	...
	/**
	 * Returns all users regardings the active site, the given Group and the given unit.<br>
	 * 
	 * @param groupId
	 *            The Group
	 * @param unitId
	 ...
	 * @return Returns all UserValue Objects in an Array. Is empty if nobody was found.
	 * 
	 * @see de.juwimm.cms.remote.UserServiceSpring#getAllUser4GroupAndUnit(java.lang.Integer, java.lang.Integer)
	 */
	@Override
	...
	/**
	 * Returns all Groups for a related user in the actual site <b>SECURITY INFORMATION:</b> Available only to: <i>siteRoot, unitAdmin</i>
	 * 
	 * @param userName
	 ...
	 * PLEASE NOTE: DOES NOT RETURN SITEROOTS! <b>SECURITY INFORMATION:</b> Available only to: <i>siteRoot, unitAdmin</i>
	 * 
	 * @param unitId
	 *            The Unit
	 * @return Returns all UserValue Objects in an Array. Is empty if nobody was found.
	 ...
	 * <b>SECURITY INFORMATION:</b> You only can remove Tasks, if you're the sender, the receiver, <i>siteRoot</i> or in the receiver group.
	 * 
	 * @param taskId
	...
	/**
	 * Sets the given task as viewed, if the user has the required permissions therefor.
	 * 
	 * @param taskId
	 *            The TaskId, from which task the Status should be changed to Constants.TASK_STATUS_VIEWED
	 * 
	 ...
	 * This will also return true, if the User is <i>siteRoot</i> and anybody has got a new Task.
	 * 
	 * @return An Boolean Object containing true/false if the active user has a new task.
	 * 
	 ...
	 * </ul>
	 * <b>SECURITY INFORMATION:</b> Available only to: <i>changeUser, siteRoot</i>
	 * 
	 * @param userValue
	...
	/**
	 * Internal Function for returning the rights a user has to change another users data.<br>
	 * Returns true if:
	 * <ul>
	 ...
	 * <li>Authenticated User has at least the same rights level. F.e. a <i>siteRoot</i> can only be edited by a user with <i>masterRoot-</i> or <i>siteRoot-</i>Permissions</li>
	 * 
	 * @param userGiven
	 *            The user to change
	 * @return Returns true, if the authenticated user has the rights to change this user
	 */
	private boolean hasRightsForChangeUser(UserHbm userGiven) {
		...
		if (!hasRights) {
			// Only change user, if the given user is in one of the same units as the authenticated user
	...
	/**
	 * Adds a User to a specific Group. <b>SECURITY INFORMATION:</b> Available only to: <i>changeUser, siteRoot</i>
	 * 
	 * @param groupValue
	 *            The Group
	 * @param userName
	 *            The Use
	 * 
	 * @see de.juwimm.cms.remote.UserServiceSpring#addUserToGroup(de.juwimm.cms.authorization.vo.GroupValue, java.lang.String)
	 */
	@Override
	...
	/**
	 * Removes a User from a specific Group. <b>SECURITY INFORMATION:</b> Available only to: <i>changeUser, siteRoot</i>
	 * 
	 * @param gv
	 *            The Group
	 * @param userName
	 *            The User
	 * 
	 * @see de.juwimm.cms.remote.UserServiceSpring#removeUserFromGroup(de.juwimm.cms.authorization.vo.GroupValue, java.lang.String)
	 */
	@Override
	 ...
	 * 
	 * @see de.juwimm.cms.remote.UserServiceSpring#changePassword4User(java.lang.String, java.lang.String, java.lang.String)
	 */
	@Override
	...
	/**
	 * @see de.juwimm.cms.remote.UserServiceSpring#getGroups4UserInSite(java.lang.String, java.lang.Integer)
	 */
	@Override
	...
	/**
	 * @see de.juwimm.cms.remote.UserServiceSpring#setConnectedUsers4Site(java.lang.Integer, java.lang.String[])
	 */
	@Override
