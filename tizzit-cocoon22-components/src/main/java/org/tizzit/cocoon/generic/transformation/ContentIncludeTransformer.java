...
import de.juwimm.util.xml.ns.DOMHelper;
...
public class ContentIncludeTransformer extends AbstractTransformer implements Serviceable {// implements CacheableProcessingComponent {
	...
	public static final String NAMESPACE_CONTENT_INCLUDE = "http://cocoon.juwimm.com/contentInclude/1.0";
	...
	public void startElement(String uri, String localName, String qName, Attributes attrs) throws SAXException {
		...
		if (CONTENT_INCLUDE_ELEMENT.equalsIgnoreCase(localName) && NAMESPACE_CONTENT_INCLUDE.equals(uri)) { //$NON-NLS-1$
			//if (log.isDebugEnabled()) log.debug("found " + CONTENT_INCLUDE_ELEMENT); //$NON-NLS-1$
