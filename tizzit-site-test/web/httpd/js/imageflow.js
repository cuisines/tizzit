...
function ImageFlow ()
{
	...
	this.defaults =
	{
		aspectRatio:        2.918,          /* Aspect ratio of the ImageFlow container (width divided by height) */
		...
		imageFocusM:        1.5,            /* Multiplicator for the focussed image size in percent */
		...
		percentOther:       200,            /* Scale portrait and square format */
