...
public class NestableGroup extends SimplePrincipal implements Group {
	private static final long serialVersionUID = 1082108775321102765L;
	 ...
	 * @param group the instance of Group that contains the roles to set as the active Group. 
	 * @exception IllegalArgumentException, thrown if group is not an instance of Group.
	 * @return true always.
	 */
	public boolean addMember(Principal group) {
		if (!(group instanceof Group)) { throw new IllegalArgumentException("The addMember argument must be a Group"); }
	...
	public boolean isMember(Principal member) {
		if (rolesStack.size() == 0) { return false; }
