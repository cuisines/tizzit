...
public class HttpClientWrapper {
    ...
    private File propFile = new File(System.getProperty("user.home") + System.getProperty("file.separator") + ".conquest");
    private HashMap<String, HostConfiguration> hostMap = new HashMap<String, HostConfiguration>();
	...
	HostConfiguration config = (HostConfiguration) hostMap.get(host + ":" + port);		
	if (config == null) {
