...
/**
 * Messages just for the communication with the HttpClient
 * 
 * @author <a href="sascha.kulawik@juwimm.com">Sascha-Matthias Kulawik</a>
 * @version $Id$
 */
public final class HttpMessages {
	private static final String BUNDLE_NAME = "HttpMessages";
	...
	public static String getString(String key, String... placeholders) {
