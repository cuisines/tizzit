...
public class DOMNodeImpl implements org.w3c.dom.Node {
	...
	public org.w3c.dom.Document getOwnerDocument() {
		...
		node = this.adaptee;
		if (node != null && node.type == Node.RootNode) return null;
	...
	public org.w3c.dom.Node insertBefore(org.w3c.dom.Node newChild, org.w3c.dom.Node refChild) throws DOMException {
		...
		if (!(newChild instanceof DOMNodeImpl)) { throw new DOMExceptionImpl(DOMException.WRONG_DOCUMENT_ERR,
				"newChild not instanceof DOMNodeImpl"); }
		DOMNodeImpl newCh = (DOMNodeImpl) newChild;

		if (this.adaptee.type == Node.RootNode) {
			if (newCh.adaptee.type != Node.DocTypeTag && newCh.adaptee.type != Node.ProcInsTag) { throw new DOMExceptionImpl(
					DOMException.HIERARCHY_REQUEST_ERR, "newChild cannot be a child of this node"); }
			...
			if (newCh.adaptee.type != Node.StartTag && newCh.adaptee.type != Node.StartEndTag
					...
					&& newCh.adaptee.type != Node.CDATATag) { throw new DOMExceptionImpl(
					DOMException.HIERARCHY_REQUEST_ERR, "newChild cannot be a child of this node"); }
		}
		if (refChild == null) {
			...
			if (ref == null) { throw new DOMExceptionImpl(DOMException.NOT_FOUND_ERR, "refChild not found"); }
	...
	public org.w3c.dom.Node replaceChild(org.w3c.dom.Node newChild, org.w3c.dom.Node oldChild) throws DOMException {
		...
		if (oldChild == null) {
			...
			if (ref == null) { throw new DOMExceptionImpl(DOMException.NOT_FOUND_ERR, "oldChild not found"); }
			...
			if (ref.parent != null) {
				if (ref.parent.content == ref) ref.parent.content = newCh.adaptee;
				if (ref.parent.last == ref) ref.parent.last = newCh.adaptee;
			}
			if (ref.prev != null) {
			...
			for (n = ref.content; n != null; n = n.next) {
				if (n.parent == ref) n.parent = newCh.adaptee;
			}
		}
		return oldChild;
	}
