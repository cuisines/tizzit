cocoon.load("../../../tizzit-site-master/web/cforms/flow/rating_xml.js");
...
function poll(logprefix){
   ...
   for (var i in pollParams){   
    ...
    var success = cmsratingXml(logprefix, pollParams.ratingName, pollParams.site, pollParams.user, pollParams.xmlStr_s);
