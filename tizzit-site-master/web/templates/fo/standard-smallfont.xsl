...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<xsl:template match="title">
		<fo:block font-size="15pt" space-before.optimum="0pt" space-after="9pt" text-align="left" font-weight="bold">
			<xsl:apply-templates/>
		</fo:block>
	</xsl:template>
	<xsl:template match="all">
		<fo:block font-size="10pt" space-before.optimum="0pt" text-align="left">
			<xsl:apply-templates/>
		</fo:block>
	</xsl:template>
	<!--	Textblock-->
	...
	<xsl:template match="p" >
		<fo:block font-size="10pt" space-before.optimum="0pt" space-after.optimum="10pt" text-align="left">
		    <xsl:apply-templates/>
		</fo:block>
	</xsl:template>	
	<!--	fette Schrift -->
	...
	<xsl:template match="ul">
		<fo:block font-size="10pt" space-before.optimum="19pt" text-align="left"/>
	...
	<xsl:template match="li" mode="ul">
		<fo:list-item>
			...
			<fo:list-item-body start-indent="13pt" font-size="10pt" space-before.optimum="19pt" text-align="left">
				<fo:block>
					<xsl:apply-templates/>
				</fo:block>
			</fo:list-item-body>
	...
	<xsl:template match="li" mode="ol">
		<fo:list-item>
			...
			<fo:list-item-body start-indent="19pt" font-size="10pt" space-before.optimum="19pt" text-align="left">
				<fo:block>
					<xsl:apply-templates/>
				</fo:block>
			</fo:list-item-body>
