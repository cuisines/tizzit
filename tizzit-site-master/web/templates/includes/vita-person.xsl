...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="vita-person">
		<xsl:text disable-output-escaping="yes">&lt;/font&gt;</xsl:text>
		<xsl:text disable-output-escaping="yes">&lt;/td&gt;&lt;td width="18"&gt;</xsl:text><xsl:text disable-output-escaping="yes">&lt;/td&gt;&lt;/tr&gt;</xsl:text>
		<tr>
