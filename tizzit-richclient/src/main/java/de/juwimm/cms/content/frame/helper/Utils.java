...
public final class Utils {
	...
	static {
		...
		FILETYPES_SUPPORTED.put(DOCX, new FileType(DOCX, "application/msword", "doc.png"));
		...
		FILETYPES_SUPPORTED.put(XLSX, new FileType(XLSX, "application/excel", "xls.png"));
		FILETYPES_SUPPORTED.put(PPT, new FileType(PPT, "application/powerpoint", "ppt.png"));
		FILETYPES_SUPPORTED.put(PPTX, new FileType(PPTX, "application/powerpoint", "ppt.png"));
	...
	public static class FileType {
		private final String extension, mimeType, imageName;
