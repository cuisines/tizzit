...
public class DlgSavePicture extends JDialog {
	...
	private void init(){
		...
		btnFileNew.setToolTipText(rb.getString("dialog.savePicture.btnFileNew.tooltiptext"));
		btnFileNew.setText(rb.getString("dialog.savePicture.btnFileNew"));
		...
		btnFileOverwrite.setToolTipText(rb.getString("dialog.savePicture.btnFileOverwrite.tooltiptext"));
		btnFileOverwrite.setText(rb.getString("dialog.savePicture.btnFileOverwrite"));
		...
		btnSave.setToolTipText(rb.getString("dialog.savePicture.btnSave.tooltiptext"));
		btnSave.setText(rb.getString("dialog.savePicture.btnSave"));
		...
		btnCancel.setToolTipText(rb.getString("dialog.savePicture.btnCancel.tooltiptext"));
		btnCancel.setText(rb.getString("dialog.savePicture.btnCancel"));
		...
		panButtonPanel.add(btnSave, new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
				GridBagConstraints.NONE, new Insets(0, 5, 0, 35), 0, 0));
		panButtonPanel.add(btnCancel, new GridBagConstraints(2, 1, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
				GridBagConstraints.NONE, new Insets(0, 0, 0, 5), 0, 0));
		
		this.setTitle(rb.getString("dialog.save"));
		this.setLayout(new GridBagLayout());
		this.add(btnFileOverwrite, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
				GridBagConstraints.NONE, new Insets(5, 20, 0, 0), 0, 0));
		this.add(btnFileNew, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
				GridBagConstraints.NONE, new Insets(5, 20, 0, 0), 0, 0));
		this.add(txtFileName, new GridBagConstraints(0, 3, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
				GridBagConstraints.NONE, new Insets(5, 40, 0, 0), 0, 0));
		this.add(panButtonPanel, new GridBagConstraints(0, 4, 1, 1, 0.0, 0.0, GridBagConstraints.SOUTH,
				GridBagConstraints.NONE, new Insets(20, 5, 0, 0), 0, 0));
