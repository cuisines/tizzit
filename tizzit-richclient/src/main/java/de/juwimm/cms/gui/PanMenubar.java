...
public class PanMenubar extends JMenuBar {
	...
	/** Edit Menu */
	private final JMenu mnuEdit = new JMenu(rb.getString("menubar.edit"));
	private final JMenuItem mnuEditUndo = new JMenuItem(rb.getString("menubar.edit.undo"), UIConstants.MNU_FILE_EDIT_UNDO);
	private final JMenuItem mnuEditRedo = new JMenuItem(rb.getString("menubar.edit.redo"), UIConstants.MNU_FILE_EDIT_REDO);
	private final JMenuItem mnuEditCut = new JMenuItem(rb.getString("menubar.edit.cut"), UIConstants.MNU_FILE_EDIT_CUT);
	private final JMenuItem mnuEditCopy = new JMenuItem(rb.getString("menubar.edit.copy"), UIConstants.MNU_FILE_EDIT_COPY);
	private final JMenuItem mnuEditPaste = new JMenuItem(rb.getString("menubar.edit.paste"), UIConstants.MNU_FILE_EDIT_PASTE);
	private final JMenuItem mnuEditDelete = new JMenuItem(rb.getString("menubar.edit.delete"), UIConstants.MNU_EMPTY);

	/** Publish Menu */
	private final JMenu mnuPublish = new JMenu(rb.getString("ribbon.publish"));
	private final JMenuItem mnuPublishLetRelease = new JMenuItem(rb.getString("menubar.publish.letRelease"));
