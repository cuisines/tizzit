 ...
 * @version $Id$
 */
public class PageInternallinkNode extends PageNode {
	public PageInternallinkNode(ViewComponentValue value, DefaultTreeModel treeModel) {
		super(value, treeModel);

		if (getViewComponent().getDisplayLinkName() == null || getViewComponent().getDisplayLinkName().equals("")) {
			getViewComponent().setDisplayLinkName("[neuer Sprung]");
		}
	}
