...
alter table `edition` add column `UPDATE_SITE_INDEX` SMALLINT NULL;
alter table `edition` add column `EXTERNAL_SITE_SEARCH` SMALLINT NULL;
# oracle
...
alter table edition add UPDATE_SITE_INDEX NUMBER(5) NULL;
alter table edition add EXTERNAL_SITE_SEARCH NUMBER(5) NULL;
# sapdb
...
alter table edition add UPDATE_SITE_INDEX SMALLINT NULL;
alter table edition add EXTERNAL_SITE_SEARCH SMALLINT NULL;
# mssql
alter table edition add WORK_SERVER_EDITION_ID INTEGER NULL;
